...
export const M1MaxElements:FC<M2MaxType> = ({showChipName}) => {
    ...
    return (
      <div className="left-name">
        <div className="text">
          ...
          <span className="chip-name">M1 MAX</span>
        </div>
      </div>
    )
  }
...
export const AppleM1Max:FC = () => {
  return (
    <div className="chip-bg dark-bg">
      <div className="main-container frame-m1max">
        <div className="frame-item-m1-max">
          <div className="chip-frame">
            <M1MaxElements showChipName={true} />
          </div>
        </div>
      </div>
    </div>
