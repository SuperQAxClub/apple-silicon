...
export const AppleA12X:FC = () => {
    ...
    return (
      <div className="left-name">
        <div className="text">
          ...
          <span className="chip-name">A12X</span>
        </div>
      </div>
    )
  }
  ...
  const Gpu:FC = () => {
    const coreCount = 8;
    let coreCountArray:number[] = [];
    for (let index = 1; index <= coreCount; index++) {
      coreCountArray.push(index);
    }
    const Core:FC = () => {
    ...
    const CoreDisabled:FC = () => {
      ...
      return (
        <div className="core-disabled">
          {coreGridCountArray.map((item, index) => (
            <div className={`core-${item}`} key={`gpuCoreDisabled${index}`}></div>
          ))}
        </div>
      )
    }
    return (
      <div className="gpu">
        {coreCountArray.map((item, index) => (
          <Fragment>
            {item === 8 ? (
              <CoreDisabled key={`gpu${index}`} />
            ) : (
              <Core key={`gpu${index}`} />
            )}
          </Fragment>
  ...
  return (
    <div className="chip-bg dark-bg">
      <div className="main-container frame-a12x">
